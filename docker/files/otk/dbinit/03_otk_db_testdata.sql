...
values ('5eed868e-7ad0-4172-88f2-704bcf78b61e', '2054e4d7-77f2-46c9-bc4d-11a47255a6ec', 'ENABLED', 'admin', '123456800-otk', 'OpenID Connect Basic Client Profile', 'https://gw2.10.aricday.net:8443/oauth/v2/client/bcp?auth=done', 'openid email profile phone address', '{}',0);
--
...
insert into oauth_client_key (client_key, secret, status, created_by, client_ident, client_name, callback, scope, custom, masterkey_flag)
values ('5edc4a38-75ec-4617-8854-1a71ff1e0a2e', '5005a669-0295-4602-be7d-6a75342db6d8', 'ENABLED', 'admin', '123456801-otk', 'OpenID Connect Implicit Client Profile', 'https://gw2.10.aricday.net:8443/oauth/v2/client/icp?auth=done', 'openid email profile phone address', '{}',0);
--
...
VALUES ('54f0c455-4d80-421f-82ca-9194df24859d', 'a0f2742f-31c7-436f-9802-b7015b8fd8e6', 'ENABLED', 'admin', 'TestClient2.0', 'OAuth2Client', 'https://gw2.10.aricday.net:8443/oauth/v2/client/authcode?auth=done,https://gw2.10.aricday.net:8443/oauth/v2/client/implicit?auth=done', '{}',0);
